<?php $__env->startSection('content'); ?>
    ...
    <section class="row new-post">
        <div class="col-md-3">
            ...
            -->
            <p><button><?php echo '@';?><?php echo e($user->user_name); ?></button></p>
            </div>
        ...
        <div class="clearfix">
         ...
         <?php foreach($posts as $post): ?>
                <article style="padding-top:5px;" class="post row" data-postid="<?php echo e($post->id); ?>">
                <div class="col-md-1">
                ...
                <div class="col-md-10">
                <span style="font-size:14px; font-weight:700"><?php echo e($post->user->first_name); ?></span>
                <span style="font-size:14px; color:#808080	;"><?php echo "@"; ?><?php echo e($post->user->user_name); ?> </span>
               
               <!-- <p>Posted by: <?php echo e($post->user->first_name); ?> at <?php echo e($post->created_at); ?></p> -->
...
<?php
 ...
 ?>
                        ...
                        <?php echo e(Auth::user()->likes()->where('post_id', $post->id)->first() ? Auth::user()->likes()->where('post_id', $post->id)->first()->like == 0 ? 'You don\'t like this post' : 'Dislike' : 'Dislike'); ?>
                        ...
                        <?php if(Auth::user() == $post->user): ?>
                            ...
                            <a href="<?php echo e(route('post.delete', ['post_id' => $post->id])); ?>"><i class="fa fa-trash   col-md-2  col-md-offset-1"></i></a>
                        <?php endif; ?>
                    </div>
                    </div>
                    </div>
